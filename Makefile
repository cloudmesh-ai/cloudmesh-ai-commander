######################################################################
# Cloudmesh AI Commander Makefile
######################################################################
...
help:
	@echo
	@echo "Makefile for the Commander Cloudmesh extension:"
	@echo
...
test-cov:
	pytest --cov=cloudmesh.ai.command.commander --cov-report=term-missing tests/
